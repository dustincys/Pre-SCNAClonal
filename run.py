...
parser_THetA.add_argument('--seg_length', default=1000, type=int,
                          help='''Set the minimum length of segment''')
...
parser_THetA.add_argument('--lm_lowerbound', default=-0.5, type=float,
                          help='''Set the lowerbound of tumorCount/normalCount
                          for gc correction''')

parser_THetA.add_argument('--lm_upperbound', default=0.5, type=float,
                          help='''Set the upperbound of tumorCount/normalCount
                          for gc correction''')

parser_THetA.add_argument('--delta', default=0.1, type=float,
                          help='''Set the delta for clustering algorithm ''')
